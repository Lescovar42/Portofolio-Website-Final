  ...
  return (
    <section id="contact" className="relative py-32 overflow-hidden flex items-center justify-center min-h-[800px]">
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-center">
        ...
        >
          {[
            { icon: <GithubIcon />, href: "https://github.com/Lescovar42" },
            { icon: <LinkedinIcon />, href: "https://www.linkedin.com/in/muhammad-farhan-abdul-azis-29a1a7319/" },
            { icon: <InstagramIcon />, href: "https://www.instagram.com/farhn.abdl" },
          ].map((social, index) => (
            <motion.a
              key={index}
              href={social.href}
